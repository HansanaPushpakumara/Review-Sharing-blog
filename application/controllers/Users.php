    ...
    //-----------------------------------register=============================
        ...
        public function register(){
			...
			if($this->form_validation->run() === FALSE){
				...
				$this->session->set_flashdata('user_registered','You are registered. You can login now');
				redirect('login');
			}
		}
...
//if u name existed
		function check_username_exists($email){
			$this->form_validation->set_message('check_username_exists','This email is already existed');
...
//================================edit profile====================
		...
		$this->form_validation->set_rules('name','Name','required');
		$this->form_validation->set_rules('email','Email','required');
			$this->form_validation->set_rules('phone','Phone No','required|min_length[10]');
