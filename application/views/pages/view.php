<div class="container">
                ...
                <div class="media-content">
                    ...
                    <nav class="level is-mobile">
                        ...
                        <div class="level-right">
                            ...
                            <a href="<?php echo base_url(); ?>review/deletereview/<?php echo $re['review_id']; ?>/<?php echo $post['post_id']; ?>"> <button class="button is-danger" onclick="return ConfirmDialog();" <?php if ($user_id = $this->session->userdata('user_id') === $re['user_id']) {
                                                                                                                                                                                                                    echo '';
                                                                                                                                                                                                                } else {
                                                                                                                                                                                                                    echo 'disabled';
                                                                                                                                                                                                                }
                            ...
                            <button class="button is-warning" onclick="showDiv(<?php echo $re['review_id']; ?>)" <?php if ($user_id = $this->session->userdata('user_id') === $re['user_id']) {
                                                                                                            echo '';
                                                                                                        } else {
                                                                                                            echo 'disabled';
                                                                                                        }
    ...
    <textarea class="textarea" name="reviewcontent" placeholder="e.g. Hello world"></textarea>
    <br>
