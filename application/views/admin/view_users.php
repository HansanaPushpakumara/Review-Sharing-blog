...
<div class="field is-horizontal">
  ...
  <div class="field-body">
    <div class="field">
	  ...
	  <a href="<?php echo base_url(); ?>remove_user/<?php echo $userdata['user_id']; ?>" onclick="return ConfirmDialog()">
...
<br>
	  ...
	  <a href="<?php echo base_url(); ?>remove_post/<?php echo $post['post_id']; ?>" onclick="return ConfirmDialog()">
